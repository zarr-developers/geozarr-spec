...
_The source NetCDF CF conventions document can be cited as follows:_
...
This document describes the CF conventions for climate and forecast metadata designed to promote the processing and sharing of data that conforms to the <<Zarr>> specification.
...
The Zarr CF conventions have been translated for Zarr compliant from the <<NetCDF>> CF conventions, which generalize and extend the COARDS conventions <<COARDS>>.
