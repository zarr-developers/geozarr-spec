...
While this term is overloaded and avoided in this document, a dataset usually represent a self-contained group of variables within a hierarchical data structure. They often share one or more dimensions and represent the unit that can be opened by a data access library (e.g., xarray)
