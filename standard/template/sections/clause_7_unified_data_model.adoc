...
* **CF Conventions** – Optional but recommended layer with metadata rules describing physical meaning, coordinate systems, and units, enabling semantic interoperability.
...
The **Climate and Forecast (CF) Conventions** build upon the CDM by defining a controlled vocabulary and metadata rules for expressing the *physical meaning* of variables and coordinates.
Because CF is explicitly based on CDM, GeoZarr can adopt CF semantics directly.
