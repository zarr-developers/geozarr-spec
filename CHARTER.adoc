...
Part of the effort of this working group is to determine what should be kept as a part of the GeoZarr core requirements, and what aspects of geospatial data should be kept as seperate conformance classes, which may or may not be applicable to specific sub-domains of the geospatial community. 
